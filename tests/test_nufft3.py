...
class TestNufft3d3:
    ...
    def test_basic_accuracy(self):
        ...
        c = (
            jax.random.normal(jax.random.PRNGKey(48), (M,), dtype=jnp.float64)
...
class TestNufft2d3FINUFFT:
    ...
    def test_nufft2d3_vs_finufft_basic(self):
        ...
        f_jax = nufft2d3(jnp.array(x), jnp.array(y), jnp.array(c),
                         jnp.array(s), jnp.array(t), n_modes, eps=1e-9)
    ...
    def test_nufft2d3_vs_finufft_precision(self, eps):
        ...
        f_jax = nufft2d3(jnp.array(x), jnp.array(y), jnp.array(c),
                         jnp.array(s), jnp.array(t), n_modes, eps=eps)
...
class TestNufft3d3FINUFFT:
    ...
    def test_nufft3d3_vs_finufft_basic(self):
        ...
        n_modes = get_n_modes_3d(jnp.array(x), jnp.array(y), jnp.array(z),
                                  jnp.array(s), jnp.array(t), jnp.array(u), eps=1e-9)
        f_jax = nufft3d3(jnp.array(x), jnp.array(y), jnp.array(z), jnp.array(c),
                         jnp.array(s), jnp.array(t), jnp.array(u), n_modes, eps=1e-9)
    ...
    def test_nufft3d3_vs_finufft_precision(self, eps):
        ...
        n_modes = get_n_modes_3d(jnp.array(x), jnp.array(y), jnp.array(z),
                                  jnp.array(s), jnp.array(t), jnp.array(u), eps=eps)
        f_jax = nufft3d3(jnp.array(x), jnp.array(y), jnp.array(z), jnp.array(c),
                         jnp.array(s), jnp.array(t), jnp.array(u), n_modes, eps=eps)
